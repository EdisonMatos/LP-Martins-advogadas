          ...
          content={({ closeIconRef, hide }) => (
            <div
              ...
              className={`${
                LightMode
                  ? "bg-white"
                  : "absolute top-0 left-0 flex-shrink-0 h-screen border-r-[1px] select-none bg-black surface-section lg:hidden lg:static z-1 surface-border border-neutral-700"
              }`}
              style={{ width: "280px" }}
            >
