  ...
  return (
    <footer
      className={
        LightMode
          ? "black"
          : "bg-gradient-to-b bg-black full gap-y-[42px] text-white font-secondFont text-left text-paragraph4 flex flex-col justify-between items-center bg-cover bg-center bg-no-repeat"
      }
    >
